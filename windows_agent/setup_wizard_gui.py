...
TRANSLATIONS = {
    "en": {
        ...
        "summary_flow_step_1": "- Keep this pairing code visible or copied somewhere safe.",
        "summary_flow_step_2": "- Open or install the PC Power Free integration in Home Assistant and wait for this PC to appear.",
        "summary_flow_step_3": "- Click configure and enter the pairing code before it expires.",
    ...
    "es": {
        ...
        "summary_flow_step_1": "- Deja este codigo visible o copiado en un sitio seguro.",
        "summary_flow_step_2": "- Abre o instala la integracion PC Power Free en Home Assistant y espera a que aparezca este PC.",
        "summary_flow_step_3": "- Pulsa configurar e introduce el codigo de vinculacion antes de que caduque.",
